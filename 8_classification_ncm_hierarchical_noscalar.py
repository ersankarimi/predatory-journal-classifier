...
METHOD_NAME = "dfs"
CLASSIFICATION_DIR = f"8_classification/ncm_hierarchical/{METHOD_NAME}_ncm_hierarchical_noscalar"
os.makedirs(CLASSIFICATION_DIR, exist_ok=True)

LOG_FILE = os.path.join(CLASSIFICATION_DIR, f"8_{METHOD_NAME}_ncm_hierarchical_noscalar.log")
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(
        CLASSIFICATION_DIR, f"8_{METHOD_NAME}_ncm_hierarchical_noscalar_model.pkl"
    )
